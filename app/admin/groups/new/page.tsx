...
export default function GroupNewPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("新規グループデータ:", formData);
    // 一覧ページに戻る
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">新規グループ登録</h1>
            <p className="text-sm text-gray-600 mt-1">新しいグループ情報を登録します</p>
          </div>
        </div>

...
import { ArrowLeft, Edit, Building, Hash, Target } from "lucide-react";
          ...
          <div className="p-6">
            ...
            <div className="mb-6 pb-6 border-b border-gray-100">
              <div className="flex items-start gap-4">
                <div className="h-16 w-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="group hover:bg-gray-50 p-4 rounded-lg transition-colors">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">業種名</p>
                    <p className="mt-1 text-sm font-medium text-gray-900">{industry.name}</p>
                  </div>
                </div>
              </div>

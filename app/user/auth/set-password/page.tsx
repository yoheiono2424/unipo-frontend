      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="inline-block bg-white p-4 rounded-2xl shadow-lg mb-4">
            <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-500 rounded-xl flex items-center justify-center">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          {error && (
            <div className="bg-orange-50 border border-red-200 rounded-lg p-3">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-orange-500 to-orange-500 text-white py-3 rounded-xl font-medium hover:from-red-600 hover:to-orange-600 transition-all duration-200 flex items-center justify-center gap-2 shadow-lg"
          >
            パスワードを設定

...
function CreateDistributionRecordContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // TODO: API呼び出し
    router.push("/advertiser/distributions/DST001");
  };
    ...
    <AdvertiserLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-4">
          <Link
            href="/advertiser/distributions/DST001"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900"
                      placeholder="店舗名を検索"
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900"
...
export default function CreateDistributionRecordPage() {
  return (
    <Suspense fallback={<AdvertiserLayout><div className="flex items-center justify-center h-96">Loading...</div></AdvertiserLayout>}>

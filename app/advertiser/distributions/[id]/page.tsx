...
const mockDistributionRecords = [
  ...
  {
    id: "DST003",
    recordId: "DIST-2025-0003",
    distributionCount: 2300,
    campaignId: "CMP003",
...
export default function AdvertiserDistributionDetailPage({ params }: { params: Promise<{ id: string }> }) {
                ...
                {filteredHistory.length === 0 ? (
                  ...
                  filteredHistory.map((history) => (
                    <tr
                      ...
                      onClick={() => router.push(`/advertiser/distribution-history/${history.id}?from=campaign&campaignId=${record.id}`)}
                    >

...
export default function AdvertiserStoreDistributionDetailPage() {
  ...
  const distributionHistory = [
    { id: "1", date: "2025-01-29 14:30", userId: "U001234", campaignId: "CMP001", campaignName: "春の新生活応援キャンペーン" },
    { id: "2", date: "2025-01-29 13:45", userId: "U001235", campaignId: "CMP001", campaignName: "春の新生活応援キャンペーン" },
    { id: "3", date: "2025-01-29 12:20", userId: "U001236", campaignId: "CMP002", campaignName: "期間限定ポイント2倍" },
    { id: "4", date: "2025-01-28 16:15", userId: "U001237", campaignId: "CMP001", campaignName: "春の新生活応援キャンペーン" },
    { id: "5", date: "2025-01-28 15:00", userId: "U001238", campaignId: "CMP003", campaignName: "バレンタインキャンペーン" },
  ];
      ...
      <AdvertiserLayout>
        <div className="p-6 space-y-6">
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <button
              onClick={() => router.push('/advertiser/distributions')}
                ...
                {filteredHistory.length === 0 ? (
                  ...
                  filteredHistory.map((item, index) => (
                    <tr
                      ...
                      onClick={() => router.push(`/advertiser/distribution-history/${item.id}?from=store&storeId=${storeId}`)}
                    >
